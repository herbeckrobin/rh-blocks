...
/**
 * GitHub-basierter Auto-Update-Checker für rh-blocks. Zieht das Release-ZIP aus den
 * GitHub Releases (Tags `v*`), inkl. gebundeltem Core und plugin-update-checker.
 */
final class UpdateChecker
{
    public const GITHUB_REPO = 'https://github.com/herbeckrobin/rh-blocks/';
    public const PLUGIN_SLUG = 'rh-blocks';
